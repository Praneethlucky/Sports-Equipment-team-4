...
<div style=" background-color: #6494e0;
  ...
  <?php if( $_SESSION['set']==1){?><li><button  onclick="retur()">Returns</button></li><?php }?>
  ...
  <?php if( $_SESSION['set']==1){?><li><button onclick="myFunction1()"><a>Enroll</a></button></li><?php }?>
  <?php if( $_SESSION['set']==1){?><li><a href="findpay.php">Find Payments</a></li><?php }?>
  <?php if( $_SESSION['set']==1){?><li><a href="logout.php">Logout</a></li><?php }?>
</ul>
<script>
...
<script>
function retur() {
	var g= document.getElementById("retudiv").value;
    var x = document.getElementById("retudiv");
	if(g==0){
    if (x.style.display === "none") {
        x.style.display = "block";
